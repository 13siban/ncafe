...
import { MenuMode, CategoryResponseDto } from '../types';
...
interface CategoryTabsProps {
    ...
    mode?: MenuMode;
    renderHeaderAction?: (categories: CategoryResponseDto[], refetch: () => void) => React.ReactNode;
}
    ...
    return (
        <aside className={styles.tabsContainer}>
            <div className={styles.header}>
                ...
                {renderHeaderAction && renderHeaderAction(categories, refetch)}
            </div>
