...
import styles from './NoticePopupForm.module.css';
...
interface NoticePopupFormProps {
    /** 페이지 제목 */
    pageTitle: string;
    /** 페이지 부제목 */
    pageSubtitle: string;
...
const NoticePopupForm: React.FC<NoticePopupFormProps> = ({
    pageTitle, pageSubtitle, initialData, submitLabel, onSubmit,
    activeLabel = '즉시 활성화',
    activeDescription = '저장 후 바로 사용자 화면에 노출을 시작합니다.',
}) => {
    const fileInputRef = useRef<HTMLInputElement>(null);
    const [formData, setFormData] = useState<FormData>(initialData || {
        title: '', content: '', imageUrl: '', isActive: false,
    });
                        ...
                        <div className={styles.checkboxWrap}>
                            <label className={styles.checkboxLabel}>
                                ...
                                <div className={styles.checkboxTextWrap}>
                                    <span className={styles.checkboxTitle}>{activeLabel}</span>
                                    <span className={styles.checkboxDesc}>{activeDescription}</span>
                                </div>
                            </label>
                        </div>
                    </div>
...
export default NoticePopupForm;
